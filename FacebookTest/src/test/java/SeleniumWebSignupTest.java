...
public void positiveSignup() throws InterruptedException {
    ...
    driver.findElement(By.id("user_username")).sendKeys("Musa345");
    //6. Locate the email address field and Input an email address on the email field
    driver.findElement(By.id("user_email")).sendKeys("bio345@gmail.com");
...
public void negativeSignup() throws InterruptedException {
    ...
    //5. Input your username on the username field
    driver.findElement(By.id("user_username")).sendKeys("b0");
    //6. Locate the email address field and Input an email address on the email field
    driver.findElement(By.id("user_email")).sendKeys("bio3436@gmail.com");
    //7. Locate the password field and Input your password on the username field
    driver.findElement(By.id("user_password")).sendKeys("password");
    //8. Click on the signup button
    driver.findElement(By.id("submit")).click();
...
public void negativeSignupIvalidEmail() throws InterruptedException {
    ...
    //5. Input your username on the username field
    driver.findElement(By.id("user_username")).sendKeys("Mokay");
    //6. Locate the email address field and Input an email address on the email field
    driver.findElement(By.id("user_email")).sendKeys("bio990086gmailcom");
    //7. Locate the password field and Input your password on the username field
    driver.findElement(By.id("user_password")).sendKeys("password");
    //8. Click on the signup button
    driver.findElement(By.id("submit")).click();
...
public void negativeSignupPasswordLessThanOneCharacter() throws InterruptedException {
    ...
    //5. Input your username on the username field
    driver.findElement(By.id("user_username")).sendKeys("Maakyy");
    //6. Locate the email address field and Input an email address on the email field
    driver.findElement(By.id("user_email")).sendKeys("bio97656686gmail.com");
    //7. Locate the password field and Input your password on the username field
...
public void negativeSignupEitherFieldBlank() throws InterruptedException {
    ...
    //5. Input your username on the username field
    driver.findElement(By.id("user_username")).sendKeys("Maydeee");
    //6. Locate the email address field and Input an email address on the email field
...
public void negativeSignupCharacter() throws InterruptedException {
    ...
    //Test3. Verify that user can not sign up with username less tha three characters
    //5. Input your username on the username field
    driver.findElement(By.id("user_username")).sendKeys("Mq");
    //6. Locate the email address field and Input an email address on the email field
    driver.findElement(By.id("user_email")).sendKeys("bio2332@gmail.com ");
    //7. Locate the password field and Input your password on the username field
    driver.findElement(By.id("user_password")).sendKeys("password");
    //8. Click on the signup button
    driver.findElement(By.id("submit")).click();
